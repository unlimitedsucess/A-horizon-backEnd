...
exports.AdminRouter.patch("/redeem/loan/:id", [isAuth_1.isAuth, general_1.default.isAdmin, validator_1.adminValidator.validateParams], utils_1.utils.wrapAsync(controller_1.adminController.redeemLoan));
